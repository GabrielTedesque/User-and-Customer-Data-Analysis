...
let
    ...
    #"Colunas Removidas" = Table.RemoveColumns(#"Duplicatas Removidas",{"employment", "address", "credit_card", "subscription"}),
    #"Tipo Alterado" = Table.TransformColumnTypes(#"Colunas Removidas",{{"id", Int64.Type}}),
...
let
    ...
    #"Limitado a 150 Linhas" = Table.FirstN(#"Column1 Expandido", 150),
    #"Duplicatas Removidas" = Table.Distinct(#"Limitado a 150 Linhas", {"id"}),
    #"Colunas Removidas" = Table.RemoveColumns(#"Duplicatas Removidas",{"uid", "password", "first_name", "last_name", "username", "email", "avatar", "gender", "phone_number", "social_insurance_number", "date_of_birth", "address", "credit_card", "subscription"}),
    #"employment Expandido" = Table.ExpandRecordColumn(#"Colunas Removidas", "employment", {"title", "key_skill"}, {"title", "key_skill"}),
    #"Tipo Alterado" = Table.TransformColumnTypes(#"employment Expandido",{{"id", Int64.Type}}),
    #"Linhas em Branco Removidas" = Table.SelectRows(#"Tipo Alterado", each not List.IsEmpty(List.RemoveMatchingItems(Record.FieldValues(_), {"", null}))),
    #"Linhas em Branco Removidas1" = Table.SelectRows(#"Linhas em Branco Removidas", each not List.IsEmpty(List.RemoveMatchingItems(Record.FieldValues(_), {"", null})))
in
    #"Linhas em Branco Removidas1"
...
let
    ...
    #"Limitado a 150 Linhas" = Table.FirstN(#"Column1 Expandido", 150),
    #"Duplicatas Removidas" = Table.Distinct(#"Limitado a 150 Linhas", {"id"}),
    #"Colunas Removidas" = Table.RemoveColumns(#"Duplicatas Removidas",{"uid", "password", "first_name", "last_name", "username", "email", "avatar", "gender", "phone_number", "social_insurance_number", "date_of_birth", "employment", "credit_card", "subscription"}),
    #"address Expandido" = Table.ExpandRecordColumn(#"Colunas Removidas", "address", {"city", "street_name", "street_address", "zip_code", "state", "country", "coordinates"}, {"city", "street_name", "street_address", "address.zip_code", "state", "country", "coordinates"}),
    #"coordinates Expandido" = Table.ExpandRecordColumn(#"address Expandido", "coordinates", {"lat", "lng"}, {"lat", "lng"}),
    #"Tipo Alterado" = Table.TransformColumnTypes(#"coordinates Expandido",{{"id", Int64.Type}}),
    #"Linhas em Branco Removidas" = Table.SelectRows(#"Tipo Alterado", each not List.IsEmpty(List.RemoveMatchingItems(Record.FieldValues(_), {"", null}))),
    #"Linhas em Branco Removidas1" = Table.SelectRows(#"Linhas em Branco Removidas", each not List.IsEmpty(List.RemoveMatchingItems(Record.FieldValues(_), {"", null})))
in
    #"Linhas em Branco Removidas1"
